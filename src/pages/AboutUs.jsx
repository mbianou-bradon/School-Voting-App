        ...
        <div>
            ...
            <div>
                <div className="w-4/5 mx-auto text-center">
                    <h2 className="text-3xl font-semibold mb-4">We aim to make school elections ease, seamless and fair</h2>
                    <p className="text-sm">This voting system was made to improve the voting system of the Wuna University. 
                ...
                <div className="w-[60%] h-full overflow-hidden mx-auto mt-5 mb-9">
                    <img src={aboutUS} alt="" className="h-[80%]"/>
                </div>

                <div className="flex flex-wrap justify-around gap-10 [&>*]:py-10 [&>*]:px-5 [&>*]:rounded-lg [&>*]:max-w-sm [&>*>div]:w-10 [&>*>div]:h-10 [&>*>div]:flex [&>*>div]:items-center [&>*>div]:justify-center [&>*>div]:rounded-full [&>*>div]:text-2xl [&>*>h2]:text-lg [&>*>h2]:font-semibold [&>*>h2]:my-3 [&>*>p]:text-sm [&>*>p]:w-[90%] [&>*>div]:mb-2">
